...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StaticFile.description'
        db.alter_column('filemanager_staticfile', 'description', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'StaticFile.description'
        db.alter_column('filemanager_staticfile', 'description', self.gf('django.db.models.fields.CharField')(max_length=200))
