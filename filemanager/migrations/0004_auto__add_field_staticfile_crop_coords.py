...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StaticFile.crop_coords'
        db.add_column('filemanager_staticfile', 'crop_coords',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'StaticFile.crop_coords'
        db.delete_column('filemanager_staticfile', 'crop_coords')
