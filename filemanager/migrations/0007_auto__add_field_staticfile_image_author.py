...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StaticFile.image_author'
        db.add_column('filemanager_staticfile', 'image_author',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'StaticFile.image_author'
        db.delete_column('filemanager_staticfile', 'image_author')
