...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StaticFile.file_version'
        db.add_column('filemanager_staticfile', 'file_version',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'StaticFile.file_version'
        db.delete_column('filemanager_staticfile', 'file_version')
